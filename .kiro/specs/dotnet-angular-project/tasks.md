...
- [ ] 1. Scaffold the .NET 10 backend solution and API project
  - [ ] 1.1 Create the backend solution and Web API project
  ...
  - [ ] 1.2 Configure Program.cs with minimal hosting, CORS, and camelCase JSON
  ...
  - [ ] 1.3 Create the Models folder and data models
  ...
  - [ ] 1.4 Create the Services folder and WeatherForecastService
  ...
  - [ ] 1.5 Create the Controllers folder with HealthCheckController and WeatherForecastController
...
- [ ] 3. Scaffold the Angular 20 frontend project
  - [ ] 3.1 Create the Angular 20 application
  ...
  - [ ] 3.2 Create frontend data models
  ...
  - [ ] 3.4 Update AppComponent to display API health status
...
- [ ] 4. Configure development proxy
  - [ ] 4.1 Create proxy configuration file
  ...
  - [ ] 4.2 Wire proxy config into Angular dev server
...
- [ ] 6. Backend tests
  - [ ] 6.1 Set up the backend test project
  ...
  - [ ] 6.2 Write unit tests for health and weather endpoints
  ...
  - [ ]* 6.3 Write property test for camelCase JSON serialization (Property 1)
...
- [ ] 9. Create root-level README with build and run instructions
...
- [ ] 10. Final checkpoint - Ensure everything builds and all tests pass
  - Ensure all tests pass, ask the user if questions arise.
